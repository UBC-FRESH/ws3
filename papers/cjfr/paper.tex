...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vspace{1.5cm}
    {\large Gregory Paradis\\Faculty of Forestry, University of British Columbia, Canada\\Corresponding author: gregory.paradis@ubc.ca\par}
    \vspace{1.5cm}
    ...
    The work has been submitted to \textit{Environmental Modelling \& Software} for peer review.\\
    Subsequent versions may differ. If accepted, the peer\hyp reviewed version will be available from the journal.\par}
    \vspace{1.0cm}
    {\normalsize Preprint DOI: \url{https://eartharxiv.org/repository/view/10500/}\par}
    \vspace{0.8cm}
    {\normalsize Date: \today\par}
    \vspace{0.8cm}
    {\normalsize Licensing: This preprint is distributed under the Creative Commons Attribution 4.0 International (CC BY 4.0) license.\par}
  \end{center}
  \vfill
\end{titlepage}
\setcounter{page}{2}
