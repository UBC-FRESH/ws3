...
\begin{figure}[htbp]
  ...
  \caption{Period-wise parity of harvested area and harvested volume between WS3 and Woodstock on the toy dataset (identical schedule). Woodstock series are drawn from the accompanying CSVs when provided; otherwise the curves coincide by construction.}
