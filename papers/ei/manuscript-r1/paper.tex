...
\begin{itemize}
  ...
  \item Reproducibility: deterministic reproduction package (\path{papers/ems/repro}) that regenerates all figures and tables; tests validate examples.
...
\begin{table}[h]
  ...
  \begin{tabular}{p{2.1cm}p{3.4cm}p{6.1cm}}
    ...
    Reusable & Documentation, provenance, validation & ReadTheDocs site; notebooks/examples; \texttt{pytest} suite; deterministic scripts in \path{papers/ems/repro}; submission checklist metadata \\
    \bottomrule
  \end{tabular}
\end{table}
