...
Deep-dive guides for power users, developers, and LLM coding agents. These
pages cover architecture, integration patterns, and advanced workflows that
go beyond the how-to level.

Guides
======

Advanced guides for extending ws3, performance tuning, and agent workflows.
